export default function Profile(props:any) {
    return <div className={props.className ?? '' + ' relative'} >
        ...
        <div className="overflow-hidden rounded-full absolute z-10 h-full w-full cursor-pointer shadow-lg shadow-black hover:shadow-blue-900 bg-[url('/images/trippings.jpg')] bg-cover bg-top hover:bg-center  transition-all">
